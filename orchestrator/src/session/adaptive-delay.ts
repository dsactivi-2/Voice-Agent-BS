 ...
 */
export function calculateAdaptiveDelay(transcript: string, actualLatencyMs: number): number {
  ...
  targetDelayMs = Math.min(targetDelayMs, config.ADAPTIVE_DELAY_MAX_MS);
